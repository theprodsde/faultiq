...
func main() {
    log.Println("=== Seeding Analytics Dashboard Graph (with correct namespace) ===")
    
    namespace := "analytics-dashboard:prod"
    ...
    log.Println("\n✓ Analytics Dashboard graph seeded with correct namespace!")
}
